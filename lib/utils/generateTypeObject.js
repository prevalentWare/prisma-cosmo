...
var getModelUniqueFields = function (uniqueFields) {
    ...
    return uniqueFields.map(function (field) { return "\n    ".concat(field.name, ": ").concat(field.type
        .replace('String', 'string')
        .replace('DateTime', 'Date')
        .replace(/(Int|Float|Decimal)/, 'number')
        .replace('Boolean', 'boolean')
...
var getModelFields = function (fields) { return fields.map(function (field) { return "\n  ".concat(field.name).concat(!field.required ? '?' : '', ": ").concat(field.type
    .replace('String', 'string')
    .replace('DateTime', 'Date')
    .replace(/(Int|Float|Decimal)/, 'number')
    .replace('Boolean', 'boolean')
...
var getModelCreateInputFields = function (fields) { return fields.filter(function (field) { return !(field.isId ||
    field.isRelatedModel ||
    field.isArray ||
    field.name === 'updatedAt' ||
    field.name === 'createdAt'); }).map(function (field) { return "\n  ".concat(field.name).concat(!field.required ? '?' : '', ": ").concat(field.type
    .replace('String', 'string')
    .replace('DateTime', 'Date')
    .replace(/(Int|Float|Decimal)/, 'number')
    .replace('Boolean', 'boolean')
    .replace(/(JSON|Json)/, 'Object<any>')); }).join(''); };
var getModelUpdateInputFields = function (fields) { return fields.filter(function (field) { return !(field.isId ||
    field.isRelatedModel ||
    field.isArray ||
    field.name === 'updatedAt' ||
    field.name === 'createdAt'); }).map(function (field) { return "\n  ".concat(field.name, "?: ").concat(field.type
...
var createTypeObject = function (parsedModels, enums) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                enumsString = enums ? enums.map(function (e) { return e.replace('enum ', ''); }).join(', ') : '';
