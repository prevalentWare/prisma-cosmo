...
var createResolvers = function (model, parsedModels) { return __awaiter(void 0, void 0, void 0, function () {
    var relatedFields, resolverFile, generalResolverFile;
                ...
                resolverFile = "\n    import { ".concat(relatedFields
                    ...
                    rf.attributes.length > 0 &&
                        ...
                        if (rf.attributes.length > 0) {
                            ...
                            return "".concat(rf.name, ": async (parent: ").concat(rf.type, ", _: null, { db, session }) => {\n                  ").concat((0, capitalize_1.unCapitalize)(model.name), "DataLoader.").concat(rf.name, "Loader.clearAll()   \n                  return await ").concat((0, capitalize_1.unCapitalize)(model.name), "DataLoader.").concat(rf.name, "Loader.load(parent.").concat(relatedField_1, ");\n                }");
                        }
                        else {
                            return "".concat(rf.name, ": async (parent: ").concat(rf.type, ", _: null, { db,session }) => {\n                    ").concat((0, capitalize_1.unCapitalize)(model.name), "DataLoader.").concat(rf.name, "Loader.clearAll()  \n                    return await ").concat((0, capitalize_1.unCapitalize)(model.name), "DataLoader.").concat(rf.name, "Loader.load(parent.id);\n                    }");
                        }
