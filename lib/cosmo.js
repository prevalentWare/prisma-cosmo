...
var createSessionConfig_1 = require("./utils/createSessionConfig");
...
var cosmo = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readFile(path_1.default.join(process.cwd(), 'prisma/schema.prisma'), { encoding: 'utf-8', })];
            case 1:
                file = _a.sent();
            ...
            case 2:
                ...
                (0, createDirectory_1.createDirectory)('./prisma/generated/sessionConfig');
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, createSessionConfig_1.createSessionConfig)(gqlSchemas, parsedModels)];
            case 6:
                _a.sent();
