        ...
        switch (_a.label) {
            case 0:
                ...
                resolverFile = "\n    import prisma from 'config/prisma';\n\n    const ".concat(model.name, "Resolvers = {\n    ").concat(model.name, ": {\n        ").concat(relatedFields
                    ...
                    .join(','), "}\n        })\n      },\n      delete").concat(model.name, ":async (_, args)=>{\n        return await prisma.").concat((0, capitalize_1.unCapitalize)(model.name), ".delete({\n          where:{\n            id:args.where.id\n          }\n        })\n      },\n    }\n    },\n\n    export { ").concat(model.name, "Resolvers };\n\n    ");
                return [4 /*yield*/, (0, writeFile_1.writeFile)(path_1.default.join(process.cwd(), "prisma/generated/".concat(model.name.toLowerCase(), "/resolvers.ts")), resolverFile)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
